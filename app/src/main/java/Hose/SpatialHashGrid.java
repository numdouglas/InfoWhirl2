...
public class SpatialHashGrid {
    ...
    public void removeObject(GameObject obj) {//detect celll obje\ct is in then delete from static or dynamic list accordingly
        int[] cellIds = getCellIds(obj);
        int i = 0;
        int cellId = -1;
        while(i <= 3 && (cellId = cellIds[i++]) != -1) {
    ...
    public void clearDynamicCells(GameObject obj) {//callled each frame before we reinsert dynamic objects
